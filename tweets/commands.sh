python offlineGuidedOutputsChoice.py \
    ...
    --results_file=results_fr_support_LePen_200_sampled_xan_seed_123.csv && \
...
python offlineGuidedOutputsChoice.py \
    ...
    --results_file=results_fr_support_Macron_200_sampled_xan_seed_123.csv && \
...
python offlineGuidedOutputsChoice.py \
    ...
    --results_file=results_fr_support_Mélenchon_200_sampled_xan_seed_123.csv && \
...
python offlineGuidedOutputsChoice.py \
    ...
    --results_file=results_fr_criticism_LePen_200_sampled_xan_seed_123.csv && \
...
python offlineGuidedOutputsChoice.py \
    ...
    --results_file=results_fr_criticism_Macron_200_sampled_xan_seed_123.csv && \
...
python offlineGuidedOutputsChoice.py \
    ...
    --results_file=results_fr_criticism_Mélenchon_200_sampled_xan_seed_123.csv && \
...
python offlineGuidedOutputsChoice.py \
    ...
    --results_file=results_fr_vote_intention_LePen_200_sampled_xan_seed_123.csv && \
...
python offlineGuidedOutputsChoice.py \
    ...
    --results_file=results_fr_vote_intention_Macron_200_sampled_xan_seed_123.csv && \
...
python offlineGuidedOutputsChoice.py \
    ...
    --results_file=results_fr_vote_intention_Mélenchon_200_sampled_xan_seed_123.csv && \
...
python offlineGuidedOutputsChoice.py \
    ...
    --results_file=results_en_support_LePen_200_sampled_xan_seed_123.csv && \
...
python offlineGuidedOutputsChoice.py \
    ...
    --results_file=results_en_support_Macron_200_sampled_xan_seed_123.csv && \
...
python offlineGuidedOutputsChoice.py \
    ...
    --results_file=results_en_support_Mélenchon_200_sampled_xan_seed_123.csv && \
...
python offlineGuidedOutputsChoice.py \
    ...
    --system_prompt="You are an expert in French politics." \
    --results_file=results_en_criticism_LePen_200_sampled_xan_seed_123.csv && \
...
python offlineGuidedOutputsChoice.py \
    ...
    --system_prompt="You are an expert in French politics." \
    --user_prompt="You're going to classify social media posts that were posted in the weeks leading up to the 2022 presidential election in France. You will classify the messages according to whether they express criticism or negative attitudes towards Macron in this election. You must use only the information contained in the message, and you must answer only with YES or NO. Does the following message express criticism or negative attitudes towards Macron: ${tweet}" \
    --results_file=results_en_criticism_Macron_200_sampled_xan_seed_123.csv && \
...
python offlineGuidedOutputsChoice.py \
    ...
    --system_prompt="You are an expert in French politics." \
    --user_prompt="You're going to classify social media posts that were posted in the weeks leading up to the 2022 presidential election in France. You will classify the messages according to whether they express criticism or negative attitudes towards Mélenchon in this election. You must use only the information contained in the message, and you must answer only with YES or NO. Does the following message express criticism or negative attitudes towards Mélenchon: ${tweet}" \
    --results_file=results_en_criticism_Mélenchon_200_sampled_xan_seed_123.csv && \
...
python offlineGuidedOutputsChoice.py \
    ...
    --system_prompt="You are an expert in French politics." \
    --results_file=results_en_vote_intention_LePen_200_sampled_xan_seed_123.csv && \
...
python offlineGuidedOutputsChoice.py \
    ...
    --results_file=results_en_vote_intention_Macron_200_sampled_xan_seed_123.csv && \
