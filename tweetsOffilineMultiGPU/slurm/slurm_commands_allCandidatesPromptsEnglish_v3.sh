...
export OUTFOLDER=outputs/v3/2xH100_max_model_len_7000_Llama-3.3-70B-Instruct/guided
sbatch \
    --job-name=${OUTFOLDER} \
...
export CHOICES="'Macron,Mélenchon,Le Pen,None'"
export OUTFOLDER=outputs/v3/4xH100_Mistral-Large-Instruct-2411/guided
sbatch \
    --job-name=${OUTFOLDER} \
    --output=$(pwd)/${OUTFOLDER}/%j.log  \
    --gres=gpu:h100:4 \
