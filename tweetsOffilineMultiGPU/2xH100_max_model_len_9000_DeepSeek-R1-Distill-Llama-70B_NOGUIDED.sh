...
#SBATCH --job-name=2xH100_max_model_len_9000_DeepSeek-R1-Distill-Llama-70B_NOGUIDED # Nom du job
#SBATCH --output=/sps/humanum/user/jroyolet/dev/llmBenchmarks/tweetsOffilineMultiGPU/2xH100_max_model_len_9000_DeepSeek-R1-Distill-Llama-70B_NOGUIDED/%j.log   # Standard output et error log
...
export IDX=2xH100_max_model_len_9000_DeepSeek-R1-Distill-Llama-70B_NOGUIDED

cmd="python ${BASEPATH}/tweets.py \
        --model_params='{\"model\": \"deepseek-ai/DeepSeek-R1-Distill-Llama-70B\", \"guided_decoding_backend\": \"xgrammar\", \"seed\": 119, \"tensor_parallel_size\": 2, \"max_model_len\": 9000}' \
