...
#SBATCH --job-name=2xH100_max_model_len_9000_DeepSeek-R1-Distill-Llama-70B # Nom du job
#SBATCH --output=/sps/humanum/user/jroyolet/dev/llmBenchmarks/tweetsOffilineMultiGPU/2xH100_max_model_len_9000_DeepSeek-R1-Distill-Llama-70B/%j.log   # Standard output et error log
...
export IDX=2xH100_max_model_len_9000_DeepSeek-R1-Distill-Llama-70B
