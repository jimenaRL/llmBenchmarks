...
#SBATCH --job-name=1xV100_zephyr-7b-beta_NOGUIDED # Nom du job
#SBATCH --output=/sps/humanum/user/jroyolet/dev/llmBenchmarks/tweetsOffilineMultiGPU/1xV100_zephyr-7b-beta_NOGUIDED/%j.log   # Standard output et error log
...
python /sps/humanum/user/jroyolet/dev/llmBenchmarks/tweetsOffilineMultiGPU/tweets.py \
  ...
  --sampling_params='{"temperature": 0.7, "top_p": 0.95, "top_k": 50, "max_tokens": 1028, "repetition_penalty": 1.2, "seed": 19}' \
  ...
  --logfile=/sps/humanum/user/jroyolet/dev/llmBenchmarks/tweetsOffilineMultiGPU/1xV100_zephyr-7b-beta_NOGUIDED/out.log \
  --outfolder=/sps/humanum/user/jroyolet/dev/llmBenchmarks/tweetsOffilineMultiGPU/1xV100_zephyr-7b-beta_NOGUIDED
