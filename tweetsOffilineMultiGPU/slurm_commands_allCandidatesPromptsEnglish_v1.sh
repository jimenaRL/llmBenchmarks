...
export CHOICES="'YES,NO'"
export OUTFOLDER=1xH100_Mistral-Small-24B-Instruct-2501/guided
sbatch \
    --job-name=${OUTFOLDER} \
    --output=$(pwd)/${OUTFOLDER}/%j.log  \
    --gres=gpu:h100:1 \
...
export SAMPLINGPARAMS="'{\"temperature\": 0.15, \"seed\": 19, \"max_tokens\": 256}'"
export CHOICES="''"
export OUTFOLDER=1xH100_Mistral-Small-24B-Instruct-2501/free
sbatch \
    --job-name=${OUTFOLDER} \
    --output=$(pwd)/${OUTFOLDER}/%j.log  \
    --gres=gpu:h100:1 \
...
export SAMPLINGPARAMS="'{\"temperature\": 0.15, \"seed\": 19, \"max_tokens\": 256}'"
export CHOICES="'YES,NO'"
export OUTFOLDER=1xH100_Mistral-Small-3.1-24B-Instruct-2503/guided
sbatch \
    --job-name=${OUTFOLDER} \
    --output=$(pwd)/${OUTFOLDER}/%j.log  \
    --gres=gpu:h100:1 \
...
export SAMPLINGPARAMS="'{\"temperature\": 0.15, \"seed\": 19, \"max_tokens\": 256}'"
export CHOICES="''"
export OUTFOLDER=1xH100_Mistral-Small-3.1-24B-Instruct-2503/free
sbatch \
    --job-name=${OUTFOLDER} \
    --output=$(pwd)/${OUTFOLDER}/%j.log  \
    --gres=gpu:h100:1 \
...
export SAMPLINGPARAMS="'{\"seed\": 19, \"max_tokens\": 256}'"
export CHOICES="'YES,NO'"
export OUTFOLDER=2xH100_max_model_len_7000_Llama-3.3-70B-Instruct/guided
sbatch \
    --job-name=${OUTFOLDER} \
    --output=$(pwd)/${OUTFOLDER}/%j.log  \
    --gres=gpu:h100:2 \
...
export SAMPLINGPARAMS="'{\"seed\": 19, \"max_tokens\": 256}'"
export CHOICES="''"
export OUTFOLDER=2xH100_max_model_len_7000_Llama-3.3-70B-Instruct/free
sbatch \
    --job-name=${OUTFOLDER} \
    --output=$(pwd)/${OUTFOLDER}/%j.log  \
    --gres=gpu:h100:2 \
