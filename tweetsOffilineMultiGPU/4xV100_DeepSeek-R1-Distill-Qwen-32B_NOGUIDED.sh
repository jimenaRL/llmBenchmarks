...
#SBATCH --job-name=4xV100_DeepSeek-R1-Distill-Qwen-32B_NOGUIDED # Nom du job
#SBATCH --output=/sps/humanum/user/jroyolet/dev/llmBenchmarks/tweetsOffilineMultiGPU/4xV100_DeepSeek-R1-Distill-Qwen-32B_NOGUIDED/%j.log   # Standard output et error log
...
export IDX=4xH100_DeepSeek-R1-Distill-Qwen-32B_NOGUIDED

cmd="python ${BASEPATH}/tweets.py \
        --model_params='{\"model\": \"deepseek-ai/DeepSeek-R1-Distill-Qwen-32B\", \"guided_decoding_backend\": \"xgrammar\", \"seed\": 119, \"tensor_parallel_size\": 4}' \
