...
#SBATCH --job-name=4xH100_DeepSeek-R1-Distill-Llama-70B_NOGUIDED # Nom du job
#SBATCH --output=/sps/humanum/user/jroyolet/dev/llmBenchmarks/tweetsOffilineMultiGPU/4xH100_DeepSeek-R1-Distill-Llama-70B_NOGUIDED/%j.log   # Standard output et error log
...
export IDX=4xH100_DeepSeek-R1-Distill-Llama-70B_NOGUIDED
