...
#SBATCH --job-name=4xV100_DeepSeek-R1-Distill-Qwen-32B # Nom du job
#SBATCH --output=/sps/humanum/user/jroyolet/dev/llmBenchmarks/tweetsOffilineMultiGPU/4xV100_DeepSeek-R1-Distill-Qwen-32B/%j.log   # Standard output et error log
...
export IDX=4xH100_DeepSeek-R1-Distill-Qwen-32B
